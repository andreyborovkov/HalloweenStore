<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Order.aspx.cs" Inherits="XEx23HalloweenStore.Order" %>
...
<asp:Content ID="mainContent" ContentPlaceHolderID="mainPlaceholder" runat="server">
     ...
     <asp:UpdatePanel ID="UpdatePanel1" runat="server"> <%-- aspx code for the first row moved here--%>
        ...
        <div class="col-sm-8"><%-- product drop down and info column --%>
            ...
            <div class="form-group">
                <div class="col-sm-12"><asp:Label ID="lblUnitPrice" runat="server" ClientIDMode="Static"></asp:Label></div></div>
        </div>
